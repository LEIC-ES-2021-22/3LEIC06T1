...
#    Then I expect the button "key_create_reminder" to be present

#  Scenario: Access the "Serviço" page go in the "SRH" service and create reminder and check reminders
#    Given I am logged in
#    And I open the drawer
#    And I tap the "key_Serviços" button
#    And I tap the "SRH-service" button
#    And I tap the "key_create_reminder_window" button
#    And I tap the "key_create_reminder" button
#    And I open the drawer
#    And I tap the "key_Reminders" button
#    Then I expect the button "key_delete_reminder" to be present
#
#  Scenario: Access the "Serviço" page go in the "SRH" service and create reminder and check reminders and then delete it
#    Given I am logged in
#    And I open the drawer
#    And I tap the "key_Serviços" button
#    And I tap the "SRH-service" button
...
#    And I open the drawer
#    And I tap the "key_Reminders" button
#    And I tap the button "key_delete_reminder"
#    And I tap the button "key_confirm_delete_reminder"
#    Then I expect the button "key_delete_reminder" to be absent
#

  Scenario: Access the "Serviço" page go in the "SRH" service and check if it is open or closed
    Given I am logged in
    And I open the drawer
    And I tap the "key_Serviços" button
    And I tap the "SRH-service" button
