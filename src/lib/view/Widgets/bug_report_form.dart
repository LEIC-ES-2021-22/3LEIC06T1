...
class BugReportFormState extends State<BugReportForm> {
  ...
  void loadBugClassList() {
    ...
    bugDescriptions.forEach((int keyint, Tuple2<String, String> tup) =>
        {bugList.add(DropdownMenuItem(child: Text(tup.item1), value: keyint, key: Key('key_bug_type_op_$keyint')  ))}); //BMCL
      ...
      child: ListTileTheme(
        ...
        child: CheckboxListTile(
          ...
          title: Text(
              ...
              style: Theme.of(context).textTheme.bodyText2,
              textAlign: TextAlign.left),  key: Key('key_bug_consent'), //BMCL
